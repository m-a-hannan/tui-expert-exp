...
public class recovery implements CommandAbstraction, RootCommand {

    @Override
    public String exec(ExecutePack pack) {
        MainPack info = (MainPack) pack;
        Shell.SU.run("svc power reboot recovery");
        return info.res.getString(R.string.output_reboot_recovery);
    }
    @Override
    public int helpRes() {
        return R.string.help_reboot_recovery;
    }
